  ...
  return (
    ...
    { movie && isUserLoggedIn && (<>
      ...
      {!isUserLoggedIn && (<>
        ...
        <Box margin={4}>
          <Typography variant='h5' padding={1}>You Are Not Logged In</Typography>
          <Typography variant='h6' padding={1}>Please Logged To Proceed Further</Typography>
          <Box align={"center"} mt={4}>
          <Button onClick={()=>navigate("/auth")} variant='outlined' color='primary' sx={{borderRadius:3, margin:1}}>Login</Button>
          <Button onClick={()=>navigate("/")} variant='outlined' color='primary' sx={{borderRadius:3, margin:1}}>Cancel</Button>
          </Box>
          </Box>
        </Dialog>
      </>)}
